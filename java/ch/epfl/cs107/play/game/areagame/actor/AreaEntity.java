...
public abstract class AreaEntity extends Entity implements Interactable {
	 ...
	 * @param spriteName - name of the file containing the sprite image
	 * @param rowIndex  - index of the row where the sprites are located in the image
	 * @param nbSprites - number of sprites in the array
	 * @param spriteWidth
	 * @param spriteHeight
	 * @param gameWidth - width of the monster's graphic representation ingame
	 * @param gameHeight - height of the monster's graphic representation ingame
	 * @param depth
	 * @return 1-dimensional array of sprites
	 */
	public Sprite[] createSprites(String spriteName, int rowIndex, int nbSprites, int spriteWidth, int spriteHeight, float gameWidth, float gameHeight, float depth) {
		Sprite[] sprites = new Sprite[nbSprites];
		for (int i=0 ; i < sprites.length ; ++i) {
			sprites[i] = new RPGSprite(spriteName, gameWidth, gameHeight, this, new RegionOfInterest(i*spriteWidth, rowIndex*spriteHeight, spriteWidth, spriteHeight),
	 ...
	 * @return 1-dimensional array of sprites
	 */
	public Sprite[] createSprites(String spriteName, int rowIndex, int nbSprites, int spriteWidth, int spriteHeight, float gameWidth, float gameHeight) {
	 ...
	 * @param spriteName - name of the file containing the sprite image
	 * @param columnIndex  - index of the row where the sprites are located in the image
	 * @param nbSprites - number of sprites in the array
	 * @param spriteWidth
	 * @param spriteHeight
	 * @param gameWidth - width of the monster's graphic representation ingame
	 ...
	 * @return 1-dimensional array of sprites
	 */
	public Sprite[] createSpritesColumn(String spriteName, int columnIndex, int nbSprites, int spriteWidth, int spriteHeight, float gameWidth, float gameHeight) {
		Sprite[] sprites = new Sprite[nbSprites];
		for (int i=0 ; i < sprites.length ; ++i) {
			sprites[i] = new RPGSprite(spriteName, gameWidth, gameHeight, this, new RegionOfInterest(columnIndex*spriteWidth, i*spriteHeight, spriteWidth, spriteHeight),
	 ...
	 * @return 1-dimensional array of sprites
	 */
	public Sprite[] createSpritesColumn(String spriteName, int columnIndex, int nbSprites, int spriteWidth, int spriteHeight, float gameWidth, float gameHeight, Orientation[] orientations) {
	 ...
	 * @param spriteName - name of the file containing the sprite image
	 * @param nbRow - number of 1-dimensional sprite arrays
	 * @param spritesPerRow - number of sprites per array
	 * @param spriteWidth
	 * @param spriteHeight
	 * @param gameWidth - width of the monster's graphic representation ingame
	 * @param gameHeight - height of the monster's graphic representation ingame
	 ...
	 */
	public Sprite[][] createSpritesArrays(String spriteName, int nbRow, int spritesPerRow, int spriteWidth, int spriteHeight, float gameWidth, float gameHeight) {
	...
	public void setSpritesAnchor(Sprite[] sprites, float deltaX, float deltaY) {
		for(int i=0 ; i < sprites.length ; ++i) {
			sprites[i].setAnchor(new Vector(deltaX, deltaY));
		}
	}
	...
	protected static Animation[] createAnimationArray(int duration, Sprite[][] sprites) {
		Animation[] anims = createAnimationArray(duration, sprites, true);
		return anims;
	}
	/**
