...
public abstract class Area implements Playable {
    ...
    /**
     * Add an actor to the actors list and to the behavior area cell if the actor is an Interactable and to the interactor list if the actor
     * is an Interactor
     *
    ...
    private void addActor(Actor a, boolean safeMode) {
        ...
        if (a instanceof Interactor) { errorHappen = !interactors.add((Interactor) a); }
    ...
    /**
     * Remove an actor form the actor list and from the behavior area cell if the actor is an Interactable and from the interactor list if
     * the actor is an Interactor
     *
    ...
    private void removeActor(Actor a, boolean safeMode) {
        ...
        if (a instanceof Interactor) { errorHappen = !interactors.remove((Interactor) a); }
        if (a instanceof Interactable) {
